...
- **紫调赛场 UI**：前端采用 Shades of Purple 风格配色与扑克牌元素，夜间也能清晰阅读
...
**Q: 对手建模面板应该如何填写？**
A: 可以先根据直觉拖动滑块，例如激进度 0 表示极度被动，10 表示疯狂进攻。若掌握最近一手牌的下注金额，可在“最近动作”处注明金额与行动前底池；否则留空也会根据滑块生成画像。填写备注有助于未来牌局快速回忆对手习惯。
